 ...
 * @access  Private (Admin, Employee)
 */
router.post('/', protect, authorize('admin', 'employee'), productsController.createProduct);
 ...
 * @access  Private (Admin, Employee)
 */
router.put('/:id', protect, authorize('admin', 'employee'), productsController.updateProduct);
 ...
 */
router.delete('/:id', protect, authorize('admin'), productsController.deleteProduct);
