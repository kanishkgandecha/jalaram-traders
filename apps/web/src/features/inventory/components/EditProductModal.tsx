 ...
 * Edit Product Modal
 * ====================
 * Modal form for editing existing products (Admin only)
 * Stock cannot be edited directly - use stock operations instead
 */
...
import { Edit, AlertCircle, Info, Upload, X, Image as ImageIcon } from 'lucide-react';
...
export function EditProductModal({
    ...
    const [formData, setFormData] = useState<Partial<Product> & { company?: string }>({});
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await productsApi.updateProduct(product._id, {
                ...formData,
    ...
    return (
        ...
        >
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* Stock Info Notice */}
                <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg flex items-start gap-2 text-blue-700">
                    <Info size={18} className="mt-0.5 flex-shrink-0" />
                    <div className="text-sm">
                        <p className="font-medium">Stock Management</p>
                        <p className="text-blue-600">
                            Current stock: <strong>{product.stockTotal}</strong> |
                            Reserved: <strong>{product.stockReserved}</strong> |
                            Available: <strong>{(product.stockAvailable ?? product.stockTotal - product.stockReserved)}</strong>
                        </p>
                        <p className="mt-1 text-xs">
                            Use stock operations (Add Stock, Adjust, Mark Damaged) to modify stock levels.
                        </p>
                    </div>
                </div>
